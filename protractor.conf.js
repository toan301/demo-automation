...
exports.config = {
  ...
  specs: [
    `./src/${appName}/smoke/**/*.feature`
  ],
  SELENIUM_PROMISE_MANAGER: false,
  capabilities: {
    'browserName': 'chrome',
	'chromeOptions': {
    'args': [ '--window-size=1000,1400', '--disable-gpu', "--allow-insecure-localhost", '--no-sandbox', '--disable-dev-shm-usage', '--incognito', '--verbose', '--disable-web-security'],
